...
public class AdminUserAccountsStyle {
    ...
    public static void applyModernTableStyle(JTable table) {
        ...
        table.setSelectionBackground(new Color(28, 169, 201)); // Sea blue
        ...
        if (header != null) {
            ...
            header.setForeground(new Color(28, 169, 201));
    ...
    public static void applyModernButtonStyle(JButton button) {
        ...
        button.setBackground(new Color(28, 169, 201)); // Sea blue
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(22, 140, 168));
                button.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(28, 169, 201));
            }
        });
    }
    ...
    static class RoundedBorder extends AbstractBorder {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
            ...
            g2.setColor(new Color(28, 169, 201));
